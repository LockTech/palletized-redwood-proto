...
const Routes = () => {
  return (
    <Router>
      <Route path="/pallet-products/new" page={NewPalletProductPage} name="newPalletProduct" />
      <Route path="/pallet-products/{id}/edit" page={EditPalletProductPage} name="editPalletProduct" />
      <Route path="/pallet-products/{id}" page={PalletProductPage} name="palletProduct" />
      <Route path="/pallet-products" page={PalletProductsPage} name="palletProducts" />
      <Route path="/pallets/new" page={NewPalletPage} name="newPallet" />
      <Route path="/pallets/{id}/edit" page={EditPalletPage} name="editPallet" />
      ...
      <Route path="/products/{id}/edit" page={EditProductPage} name="editProduct" />
      ...
      <Route path="/locations/{id}/edit" page={EditLocationPage} name="editLocation" />
      <Route path="/locations/{id}" page={LocationPage} name="location" />
      <Route path="/locations" page={LocationsPage} name="locations" />
      <Route path="/warehouses/new" page={NewWarehousePage} name="newWarehouse" />
      <Route path="/warehouses/{id}/edit" page={EditWarehousePage} name="editWarehouse" />
